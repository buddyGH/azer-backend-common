...
from azer_common.middlewares.logging import log_task_message
...
async def fake_scheduler():
    print("Scheduler run...")
    log_task_message("Scheduler run...")
...
def start_verification_code_cleanup_scheduler():
    ...
    log_task_message("Scheduler start...")
    scheduler.start()


def stop_verification_code_cleanup_scheduler():
    print("Scheduler stop...")
    log_task_message("Scheduler stop...")
